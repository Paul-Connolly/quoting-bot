...
namespace QuotingBot.Common.Email
{
    public class EmailHandler
    {
        ...
        public static string BuildHomeEmailBody(HomeQuoteWebServiceResult[] responseQuotes,
        ...
        public static string BuildMotorEmailBody(IrishMQResultsBreakdown[] quotes,
